...
student_det = {'name' : 'kumar','roll_num' : 27 , 'location' : 'hyderabad', 'college':'jntuh'}
print("student details :",student_det)

office_addr = {'com_name' : 'MCS','addr':'hyd'}

merge_two = student_det.update(office_addr)
print("merge two dictionaries :",merge_two)
