...
def emp_data(name, age, roll, com='MCS', loc="bang"):
...
emp_data('kumar', 24, 26)  # positional
emp_data('kiran', 20, 25, com='TCS')  # positional # default
emp_data('kiran', 20, 25, com='ibm', loc='hyd')  # positional  # default

emp_data('yuvi', 21, 27, com='MCS', loc='bang')
# emp_data(com='ibm',loc = 'hyd','yuvi')  # SyntaxError: positional argument follows keyword argument

emp_data(name='santhosh', age=25, roll=27, com='infosys',
         loc='chennai')  # keyword

emp_data(age=24, roll=29, name='mahesh', com='mindtree',
         loc='chennai')  # keyword
