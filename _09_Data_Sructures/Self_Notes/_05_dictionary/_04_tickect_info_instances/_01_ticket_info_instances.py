                ...
                "test_files": [
                    {
                        ...
                        "file_size": "0.047 KB",
                        "file_location": "ftp://pcam-dev-app-01:2121"
                                         "/DevSCFtpServer/res/home/Software/FPD/Logs "
                                         "/626c058aa2dc11e993230050fil_upload.bin",
        ...
        "fpd_images": [
            {
                ...
                "size": 48.0,
                "extension": "bit",
                "file_location": "ftp://pcam-dev-app-01:2121/DevSCFtpServer"
                                 "/res/home/Software/FPD "
                                 "/4335e5e6a2dc11e992910050fil_upload.bit "
            },
            {
...
print("New Section".center(80, "-"))
print("id".ljust(40, "-"), ":", ticket_info["_id"])
print("active epe".ljust(40, "-"), ":", ticket_info["active_epe"])
# workflow --label

print("workflow".ljust(40, "-"), ":", ticket_info["workflow"])
print("unittestlog".ljust(40, "_"), ":",
      ticket_info["workflow"]['unit_test_logs'][0]["eta"]["value"]['date'][
          'day'])
print("dateformat".ljust(40, "_"), ":",
      ticket_info["workflow"]['unit_test_logs'][0]["eta"]["dateFormat"])
print("test_files".ljust(40, "_"), ":",
      ticket_info["workflow"]['unit_test_logs'][0]["test_files"])
print("details".ljust(40, "_"), ":", ticket_info["details"])
print("init_approver".ljust(40, "_"), ":", ticket_info["init_approver"])
# print("init_approver".ljust(40,"_"),":",ticket_info["init_approver"])
# "init_approver"

print("roles".ljust(40, "_"), ":", ticket_info["init_approver"][0]['roles'])
print("stages".ljust(40, "_"), ":", ticket_info["init_approver"][0]['stages'])

print("stages_name".ljust(40, "_"), ":",
      ticket_info["init_approver"][0]['stages'][0]['name'])

print("stages_4th index".ljust(40, "_"), ":",
      ticket_info["init_approver"][0]['stages'][4])

print("stages_enabled".ljust(40, "_"), ":",
      ticket_info["init_approver"][0]['stages'][4]['name'])
# "correlationId": "5d258697f9c8e56193bf72ce"
print("stages_enabled".ljust(40, "_"), ":", ticket_info["correlationId"])
